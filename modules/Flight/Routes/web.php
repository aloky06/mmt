...
Route::group(['prefix' => 'user/affiliate', 'middleware' => ['auth', 'verified']], function() {
    Route::get('/', 'PartnerController@dashboard')->name('flight.partner.dashboard');
    Route::post('/register', 'PartnerController@register')->name('flight.partner.register');
    Route::post('/payout/request', 'PartnerController@requestPayout')->name('flight.partner.payout.request');
});
