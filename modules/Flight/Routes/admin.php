...
// Partner Affiliate System Routes
Route::group(['prefix' => 'partner'], function () {
    Route::get('/', 'PartnerController@index')->name('flight.admin.partner.index');
    Route::post('/bulkEdit', 'PartnerController@bulkEdit')->name('flight.admin.partner.bulkEdit');
    Route::get('/payouts', 'PartnerController@payouts')->name('flight.admin.partner.payouts');
    Route::post('/payoutBulkEdit', 'PartnerController@payoutBulkEdit')->name('flight.admin.partner.payoutBulkEdit');
});
