                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" v-model="node.icon_class" class="form-control input-sm" placeholder="e.g. fa fa-plane or bi bi-house">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" v-model="node.icon_image_url" class="form-control input-sm" placeholder="e.g. /uploads/.../icon.png">
                                                        <div class="input-group-append">
                                                            <button class="btn btn-primary btn-sm" type="button" @click="openMedia(node)">
