...
<div class="ht-landing-page bravo_search_tour">
        ...
        <div class="container-fluid px-4 px-md-5" style="position:relative;z-index:10;max-width:1200px;margin:0 auto;">
            ...
            <div class="ht-hero-text">
                <h1 class="text-4xl md:text-5xl font-black mb-4 tracking-tight drop-shadow-md">
                    Discover Amazing Boats
                </h1>
                <p class="text-lg md:text-xl font-medium opacity-90 drop-shadow">
                    Luxury Yachts &middot; Sailboats &middot; Cruisers — Book the perfect boat for your next adventure.
                </p>
            </div>
    ...
    @else
        @include('Boat::frontend.layouts.search.search-summary-bar')
    @endif
    ...
    <section class="why-us-section">
        <div class="container">
            ...
            <p class="section-subtitle">Your trusted boat booking platform — safe, affordable & memorable adventures</p>
            <div class="row g-4">
                <div class="col-6 col-md-3">
                    <div class="feature-card">
                        <div class="feature-icon"><i class="fa fa-ship"></i></div>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Verified Captains</h3>
                        <p class="text-gray-500">Learn from passionate captains who know the hidden gems and rich history of every destination.</p>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="feature-card">
                        <div class="feature-icon"><i class="fa fa-ship"></i></div>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Premium Fleet</h3>
                        <p class="text-gray-500">Choose from a wide selection of well-maintained yachts, sailboats, and speedboats.</p>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="feature-card">
    ...
    <section class="stats-section">
        <div class="container">
            <div class="row text-center g-4">
                <div class="col-6 col-md-3">
                    <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform h-full flex flex-col justify-center">
                        <div class="text-4xl font-black text-brand mb-2">5,000+</div>
                        <div class="text-gray-600 font-medium">Verified Boats</div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform h-full flex flex-col justify-center">
                        <div class="text-4xl font-black text-brand mb-2">1M+</div>
                        <div class="text-gray-600 font-medium">Happy Sailors</div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform h-full flex flex-col justify-center">
                        <div class="text-4xl font-black text-brand mb-2">100+</div>
                        <div class="text-gray-600 font-medium">Marinas</div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform h-full flex flex-col justify-center">
            ...
            <div class="row g-4 position-relative">
                ...
                <div class="col-md-4">
                    <div class="step-card">
                        ...
                        <h5>Choose Your Boat</h5>
                        <p>Browse available boats, compare itineraries, check reviews and find your match.</p>
                        <div class="step-arrow d-none d-md-block"><i class="fa fa-chevron-right"></i></div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="step-card">
                        ...
                        <h5>Confirm & Stay</h5>
                        <p>Pay securely online, receive your booking voucher instantly, and enjoy your cruise!</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="routes-section">
        <div class="container">
            ...
            <p class="section-subtitle">Thousands of travellers book boat rentals in these cities every day</p>
            <div class="text-center">
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Boats in Goa</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Boats in Delhi</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Boats in Mumbai</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Boats in Jaipur</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Boats in Bangalore</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Boats in Udaipur</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Boats in Shimla</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Boats in Manali</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Boats in Chennai</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Boats in Kolkata</a>
            </div>
        </div>
    </section>
    ...
    <section class="faq-section">
        <div class="container">
            ...
            <p class="section-subtitle">Everything you need to know about boat rentals</p>
                ...
                <div class="col-lg-8">
                    ...
                    <div x-data="{ active: false }" class="mb-4">
                        <button @click="active = !active" class="w-full flex items-center justify-between bg-white p-5 rounded-xl border border-gray-200 hover:border-brand transition-colors focus:outline-none group" :class="active ? 'rounded-b-none border-brand' : ''">
                            <span class="font-bold text-gray-900">Do I need a boating license?</span>
                        ...
                        <div x-show="active" x-collapse>
                            <div class="p-5 bg-white border border-t-0 border-gray-200 rounded-b-xl text-gray-600">
                                It depends on the boat. Most of our boats come with a professional captain (skippered), so no license is needed. For bareboat rentals, a valid license is required.
                            </div>
                        </div>
                    </div>
                    <!-- FAQ 2 -->
                    <div x-data="{ active: false }" class="mb-4">
                        <button @click="active = !active" class="w-full flex items-center justify-between bg-white p-5 rounded-xl border border-gray-200 hover:border-brand transition-colors focus:outline-none group" :class="active ? 'rounded-b-none border-brand' : ''">
                            <span class="font-bold text-gray-900">What is included in the price?</span>
                            <span class="text-brand group-hover:scale-110 transition-transform"><i class="fa" :class="active ? 'fa-minus-circle' : 'fa-plus-circle'"></i></span>
                        </button>
                        <div x-show="active" x-collapse>
                            <div class="p-5 bg-white border border-t-0 border-gray-200 rounded-b-xl text-gray-600">
                                Prices typically include the boat rental and insurance. Fuel, captain fees (if not specified), and provisions are usually extra. Check the specific boat listing for details.
                            </div>
                        </div>
                    </div>
                    <!-- FAQ 3 -->
                    <div x-data="{ active: false }" class="mb-4">
                        <button @click="active = !active" class="w-full flex items-center justify-between bg-white p-5 rounded-xl border border-gray-200 hover:border-brand transition-colors focus:outline-none group" :class="active ? 'rounded-b-none border-brand' : ''">
                            <span class="font-bold text-gray-900">What if the weather is bad?</span>
                            <span class="text-brand group-hover:scale-110 transition-transform"><i class="fa" :class="active ? 'fa-minus-circle' : 'fa-plus-circle'"></i></span>
                        </button>
                        <div x-show="active" x-collapse>
                            <div class="p-5 bg-white border border-t-0 border-gray-200 rounded-b-xl text-gray-600">
                                Safety is our priority. If the captain or fleet operator deems the weather unsafe, you will be offered a reschedule or a full refund depending on their policy.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 mb-4">
                    ...
                    <a href="#">Delhi Boats</a>
                    <a href="#">Mumbai Boats</a>
                    <a href="#">Bangalore Boats</a>
                    <a href="#">Pune Boats</a>
                    <a href="#">Hyderabad Boats</a>
                </div>
                <div class="col-md-3 mb-4">
                    <h5><i class="fa fa-star mr-2" style="color:#ff5f1f;"></i> Luxury Boats</h5>
                    <a href="#">Private Yachts in Goa</a>
                    <a href="#">Luxury Cruisers in Delhi</a>
                    <a href="#">Private Sailboats in Mumbai</a>
                    <a href="#">Speedboats in Udaipur</a>
                    <a href="#">Heritage Cruises in Jaipur</a>
                </div>
                <div class="col-md-3 mb-4">
                ...
                <div class="col-md-3 mb-4">
                    <h5><i class="fa fa-tree mr-2" style="color:#ff5f1f;"></i> Boat Types</h5>
                    <a href="#">Day Cruises</a>
                    <a href="#">Multi-day Charters</a>
                    <a href="#">Private Yachts</a>
                    <a href="#">Group Cruises</a>
                    <a href="#">Speedboats</a>
                </div>
            </div>
        </div>
