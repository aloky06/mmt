            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="price_per_km" class="form-control" value="{{$row->price_per_km}}" placeholder="{{__("Per KM Price")}}">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="control-label">{{__("4 Hrs / 40 Km Price")}}</label>
                        <input type="number" step="any" min="0" name="price_4hr" class="form-control" value="{{$row->price_4hr}}" placeholder="{{__("4 Hrs Package Price")}}">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="form-group">
                        <label class="control-label">{{__("8 Hrs / 80 Km Price")}}</label>
                        <input type="number" step="any" min="0" name="price_8hr" class="form-control" value="{{$row->price_8hr}}" placeholder="{{__("8 Hrs Package Price")}}">
                    </div>
                </div>
            </div>
        @endif
