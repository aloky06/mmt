@extends('Layout::app')
@section('head')
<title>{{ __('Taxi Submitted Successfully') }} — {{ setting_item('site_title','BookingCore') }}</title>
<style>
...
.car-preview-icon { font-size: 32px; }
.car-preview-name { font-size: 15px; font-weight: 700; color: #1e293b; }
.car-preview-sub { font-size: 12px; color: #64748b; }
@endif
</style>
@endsection
...
<div class="success-wrap">
    <div class="success-card">
        ...
        <h1>Taxi Submitted!</h1>
        <p class="subtitle">
            Congratulations! Your car has been successfully submitted for review.<br>
            Our admin team will verify your listing within <strong>24–48 hours</strong>.
        </p>

        @if($car)
        <div class="car-preview">
            <div class="car-preview-icon">🏨</div>
            <div>
                <div class="car-preview-name">{{ $car->title }}</div>
                <div class="car-preview-sub">{{ $car->address ?? 'Address not provided' }}</div>
            </div>
        ...
        <div class="timeline">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-text">
                    ...
                    <span>Our team will verify your Taxi details and documents.</span>
                </div>
            </div>
            <div class="timeline-item">
                ...
                <div class="timeline-text">
                    ...
                    <span>Once approved, your Taxi will appear in search results.</span>
                </div>
            </div>
        </div>
        ...
        <div class="success-actions">
            @if($car)
            <a href="{{ route('car.vendor.dashboard', ['id' => $car->id]) }}" class="btn-primary-custom">
                🏠 Go to Dashboard
            </a>
            @endif
            <a href="{{ route('car.vendor.index') }}" class="btn-outline-custom">
                📋 My Properties
            </a>
            <a href="{{ route('car.list.landing') }}" class="btn-outline-custom">
                + List Another
            </a>
        </div>

        <p style="font-size:12px;color:#94a3b8;margin-top:24px;">
            📧 You will receive an email notification once your Taxi is approved or if additional information is needed.
        </p>
    </div>
</div>
@endsection
