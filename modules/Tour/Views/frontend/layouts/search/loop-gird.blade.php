@php
    ...
    // Review Data
    $reviewData = setting_item('tour_enable_review') ? $row->getScoreReview() : null;
@endphp
            ...
            <div>
                ...
                <div class="flex items-center gap-2 mb-3">
                    ...
                    @if(!empty($row->location->name))
                        ...
                        <a href="{{ route('tour.search', ['location_id' => $row->location->id]) }}" class="text-sm text-blue-600 hover:underline flex items-center gap-1 font-medium">
                            {{$location->name ?? ''}}
                        </a>
                    @endif
                </div>
                ...
                @if($duration)
                    <div class="flex items-center gap-2 mt-4 text-gray-600 text-sm font-medium">
