@extends('Layout::app')
@section('head')
<title>{{ __('List Your Hotel Property') }} — {{ setting_item('site_title','BookingCore') }}</title>
<meta name="description" content="List your hotel on our platform. Start accepting bookings and reach thousands of travelers today.">
<style>
:root {
    --navy: #003580;
    --blue: #0071c2;
...
<section class="lp-hero">
    <div class="lp-hero-content">
        <h1>List Your Hotel &amp; <span>Start Earning</span></h1>
        ...
        <div class="lp-hero-btns">
            <a href="{{ route('hotel.list.register') }}" class="lp-btn-primary">🚀 Get Started — It's Free</a>
...
<section class="lp-section lp-benefits-bg">
    <h2 class="lp-section-title">Why List With Us?</h2>
...
<section class="lp-cta">
    ...
    <p>Join our growing community of hotel owners. It's free to list your property.</p>
    <a href="{{ route('hotel.list.register') }}" class="lp-btn-primary" style="display:inline-block;">
