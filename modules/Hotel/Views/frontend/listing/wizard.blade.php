@extends('Layout::app')
@section('head')
<title>{{ __('Register Your Property') }} — {{ setting_item('site_title','BookingCore') }}</title>
<meta name="description" content="Register your hotel property step by step. Complete the wizard to list your property and start accepting bookings.">
<style>
...
<div class="wiz-topbar">
    ...
    <div class="wiz-topbar-right">
        <a href="{{ route('hotel.list.landing') }}">Exit</a>
...
<div class="wiz-progress-wrap">
    <div class="wiz-progress-label">
        <strong id="stepTitle">Step 1 of 10: Property Type</strong>
...
<div class="wiz-layout">
    ...
    <div class="wiz-sidebar">
        <div class="wiz-sidebar-group">
            <div class="wiz-sidebar-group-title">Property Basics</div>
            <div class="wiz-sidebar-item active" data-step="1" onclick="goToStep(1)">
                <span class="item-icon">1</span> Property Type
            </div>
            <div class="wiz-sidebar-item" data-step="2" onclick="goToStep(2)">
                <span class="item-icon">2</span> Hotel Name &amp; Details
            </div>
    ...
    <form id="wizForm" action="{{ route('hotel.list.submit') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="wiz-step @if(Auth::check()) active @endif" id="step1">
            <div class="wiz-step-header">
                ...
                <p>Select the category that best describes your property. This helps guests find the right accommodation.</p>
            </div>
            <div class="prop-type-grid">
                <div class="prop-type-card selected" onclick="selectPropType(this,'hotel')">
                    <span class="prop-type-icon">🏨</span>
                    <div class="prop-type-name">Hotel</div>
                    <div class="prop-type-desc">Full-service hotel with dedicated staff</div>
                </div>
            ...
            <input type="hidden" name="property_type" id="property_type" value="hotel">
            <div class="wiz-nav">
                <div></div>
        ...
        <!-- ===== STEP 2: Hotel Name & Details ===== -->
        <div class="wiz-step" id="step2">
            <div class="wiz-step-header">
                <h2>What's your property called?</h2>
                <p>Enter the official name and a brief description of your property.</p>
            </div>
            <div class="wiz-card">
                <div class="wiz-field">
                    <label class="wiz-label">Property Name <span class="req">*</span></label>
                    <input type="text" name="title" class="wiz-input" placeholder="e.g. The Grand Palace Hotel" required>
                    <span class="wiz-input-hint">This is the name guests will see when searching for your property.</span>
                </div>
                <div class="wiz-field">
                    <label class="wiz-label">Property Description</label>
                    <textarea name="content" class="wiz-textarea" rows="4" placeholder="Describe your property — what makes it special, unique features, nearby attractions..."></textarea>
                </div>
                <div class="wiz-row">
                    <div>
        ...
        <div class="wiz-step" id="step3">
            <div class="wiz-step-header">
                ...
                <p>Enter the full address. This helps guests find your property easily.</p>
            </div>
            <div class="wiz-card">
                <div class="wiz-field">
                ...
                <p style="font-size:12px;color:var(--gray-400);margin-top:-8px;">
                    💡 You can get coordinates from <a href="https://maps.google.com" target="_blank" style="color:var(--blue);">Google Maps</a> — right-click on your property location.
                </p>
            </div>
            <div class="wiz-nav">
                <button type="button" class="wiz-btn wiz-btn-back" onclick="prevStep()">← Back</button>
        ...
        <div class="wiz-step" id="step4">
            <div class="wiz-step-header">
                <h2>What's the star rating of your property?</h2>
        ...
        <div class="wiz-step" id="step5">
            <div class="wiz-step-header">
                <h2>What facilities does your property offer?</h2>
                <p>Select all that apply. This helps guests choose the right property for their needs.</p>
            </div>
            <div class="wiz-card">
        ...
        <div class="wiz-step" id="step7">
            <div class="wiz-step-header">
                <h2>House Rules</h2>
                <p>Set clear expectations for guests about what's allowed at your property.</p>
            </div>
            <div class="wiz-card">
                <div class="wiz-field">
        ...
        <div class="wiz-step" id="step10">
            <div class="wiz-step-header">
                ...
                <p>Great photos attract more guests. You can add more photos after your property is listed.</p>
            </div>
            <div class="wiz-card">
        ...
        <div class="wiz-step" id="step12">
            <div class="wiz-step-header">
                ...
                <p>Tell us about who owns and manages this property.</p>
            </div>
            <div class="wiz-card">
                <div class="wiz-field">
        ...
        <div class="wiz-step" id="step13">
            ...
            <div class="wiz-card">
                <div class="wiz-summary-section">
                    <div class="wiz-summary-title">Property Information</div>
                    <div class="wiz-summary-row">
                        <span class="sk">Property Type</span>
                        <span class="sv" id="sum_type">Hotel</span>
                    </div>
                    <div class="wiz-summary-row">
                        <span class="sk">Property Name</span>
                ...
                <div style="display:flex;gap:14px;align-items:flex-start;">
                    ...
                    <div>
                        ...
                        <div style="font-size:13px;color:#78350f;line-height:1.6;">
                            After submission, our admin team will review your property within <strong>24–48 hours</strong>. 
                            You'll receive an email with the decision. Once approved, your property will go live and start receiving bookings.
                        </div>
                    </div>
                </div>
            </div>
...
const stepTitles = [
    '', // placeholder for 0
    'Step 1 of 13: Property Type',
    'Step 2 of 13: Hotel Name & Details',
...
function selectPropType(card, val) {
    ...
    document.getElementById('property_type').value = val;
}
...
function updateSummary() {
    ...
    const propType = document.getElementById('property_type')?.value || 'hotel';
