    ...
    <div class="container mx-auto px-4 py-3 flex flex-wrap md:flex-nowrap items-center justify-between gap-4" style="max-width: 1200px;">
        <div class="flex flex-1 items-center gap-4 md:gap-8 overflow-hidden w-full md:w-auto">
            <div class="flex flex-col min-w-0">
                <span class="text-[10px] text-brand-light uppercase font-bold tracking-wider opacity-80">CITY, AREA OR PROPERTY</span>
            ...
            <div class="flex flex-col whitespace-nowrap">
                <span class="text-[10px] text-brand-light uppercase font-bold tracking-wider opacity-80">ROOMS & GUESTS</span>
                <span class="font-bold text-base md:text-lg">{{ $guest_text }}</span>
            </div>
        </div>
