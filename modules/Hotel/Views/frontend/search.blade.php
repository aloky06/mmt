...
@section('content')
<div class="ht-landing-page bravo_search_hotel">
    ...
    <div class="ht-hero">
        ...
        <div class="container-fluid px-4 px-md-5" style="position:relative;z-index:10;max-width:1200px;margin:0 auto;">
            ...
            <div class="ht-hero-text">
                <div class="hero-badge"><i class="fa fa-star"></i> Top Rated Hotels Worldwide</div>
                <h1>{{setting_item_with_lang("hotel_page_search_title") ?: "Book Your Stay Online"}}</h1>
                <p>Luxury &nbsp;·&nbsp; Resorts &nbsp;·&nbsp; Budget — Best prices, verified properties, instant confirmation.</p>
            </div>
    ...
    @else
        @include('Hotel::frontend.layouts.search.search-summary-bar')
    @endif
    ...
    <section class="why-us-section">
        <div class="container">
            ...
            <p class="section-subtitle">Your trusted hotel booking platform — safe, affordable & comfortable stays</p>
            <div class="row g-4">
                ...
                <div class="col-6 col-md-3">
                    <div class="feature-card">
                        ...
                        <p>All hotels are personally verified and rated by real customers for your safety.</p>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="feature-card">
    ...
    <section class="how-section">
        <div class="container">
            ...
            <p class="section-subtitle">Book your perfect stay in 3 simple steps</p>
            <div class="row g-4 position-relative">
                ...
                <div class="col-md-4">
                    <div class="step-card">
                        ...
                        <p>Browse available hotels, compare amenities, check reviews and find your match.</p>
                        <div class="step-arrow d-none d-md-block"><i class="fa fa-chevron-right"></i></div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="step-card">
                        ...
                        <h5>Confirm & Stay</h5>
                        <p>Pay securely online, receive your booking voucher instantly, and enjoy your stay!</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="routes-section">
        <div class="container">
            ...
            <div class="text-center">
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Hotels in Goa</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Hotels in Delhi</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Hotels in Mumbai</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Hotels in Jaipur</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Hotels in Bangalore</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Hotels in Udaipur</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Hotels in Shimla</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Hotels in Manali</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Hotels in Chennai</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Hotels in Kolkata</a>
            </div>
        </div>
    </section>
    ...
    <section class="faq-section">
        <div class="container">
            ...
            <p class="section-subtitle">Everything you need to know about hotel booking</p>
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="faq-item">
                        <div class="faq-question">How do I book a hotel online? <i class="fa fa-chevron-down"></i></div>
                        <div class="faq-answer">Simply enter your destination city, check-in, check-out dates, and number of guests. Click "Search" to see available options. Choose your preferred hotel and confirm your booking.</div>
                    </div>
                    <div class="faq-item">
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer">Yes, you can cancel or reschedule your booking based on the hotel's cancellation policy. Please refer to your booking details for the specific policy applied to your reservation.</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 mb-4">
                    ...
                    <a href="#">Delhi Hotels</a>
                    <a href="#">Mumbai Hotels</a>
                    <a href="#">Bangalore Hotels</a>
                    <a href="#">Pune Hotels</a>
                    <a href="#">Hyderabad Hotels</a>
                </div>
                <div class="col-md-3 mb-4">
                    <h5><i class="fa fa-star mr-2" style="color:#ff5f1f;"></i> Luxury Hotels</h5>
                    <a href="#">5 Star Hotels in Goa</a>
                    <a href="#">5 Star Hotels in Delhi</a>
                    <a href="#">5 Star Hotels in Mumbai</a>
                    <a href="#">Luxury Resorts in Udaipur</a>
                    <a href="#">Heritage Hotels in Jaipur</a>
                </div>
                <div class="col-md-3 mb-4">
                    <h5><i class="fa fa-bed mr-2" style="color:#ff5f1f;"></i> Budget Stays</h5>
                    <a href="#">Cheap Hotels in Delhi</a>
                    <a href="#">Budget Hotels in Mumbai</a>
                    <a href="#">Hostels in Goa</a>
                    <a href="#">Guest Houses in Manali</a>
                    <a href="#">Homestays in Shimla</a>
                </div>
                <div class="col-md-3 mb-4">
                    <h5><i class="fa fa-tree mr-2" style="color:#ff5f1f;"></i> Property Types</h5>
                    <a href="#">Resorts</a>
                    <a href="#">Villas</a>
                    <a href="#">Apartments</a>
                    <a href="#">Homestays</a>
