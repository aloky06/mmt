...
// ---- List Your Property (Hotel Owner Registration Wizard) ----
Route::get('/list-your-property', 'HotelListingController@landing')->name('hotel.list.landing');
Route::get('/list-your-property/register', 'HotelListingController@register')->name('hotel.list.register');
Route::post('/list-your-property/submit', 'HotelListingController@submit')->name('hotel.list.submit');
Route::get('/list-your-property/success', 'HotelListingController@success')->name('hotel.list.success');
...
Route::group(['prefix'=>'user/'.config('hotel.hotel_route_prefix'),'middleware' => ['auth','verified']],function(){
    ...
    Route::get('/{id}/dashboard','VendorController@dashboard')->name('hotel.vendor.dashboard');
});
