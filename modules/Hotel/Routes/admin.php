...
// ---- Hotel Verification (Pending Hotels) ----
Route::get('/pending','HotelController@pendingVerification')->name('hotel.admin.pending');
Route::post('/approve/{id}','HotelController@approveHotel')->name('hotel.admin.approve');
Route::post('/reject/{id}','HotelController@rejectHotel')->name('hotel.admin.reject');
