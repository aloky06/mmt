...
<div class="ht-landing-page bravo_search_tour">
        ...
        <div class="container-fluid px-4 px-md-5" style="position:relative;z-index:10;max-width:1200px;margin:0 auto;">
            ...
            <div class="ht-hero-text">
                ...
                <p class="text-lg md:text-xl font-medium opacity-90 drop-shadow">
                    Concerts, Festivals & Exhibitions — Get your tickets now for the best experiences.
                </p>
            </div>
    ...
    @else
        @include('Event::frontend.layouts.search.search-summary-bar')
    @endif
    ...
    <section class="why-us-section">
        <div class="container">
            ...
            <p class="section-subtitle">Your trusted event booking platform — safe, affordable & memorable adventures</p>
            <div class="row g-4">
                <div class="col-6 col-md-3">
                    <div class="feature-card">
                        <div class="feature-icon"><i class="fa fa-tag"></i></div>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Top Events</h3>
                        <p class="text-gray-500">From local meetups to global festivals, discover events happening near you.</p>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <!-- Feature 2 -->
                    <div class="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-shadow border border-gray-100 group">
                        <div class="w-14 h-14 bg-orange-50 text-brand rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                            <i class="fa fa-ticket text-2xl"></i>
                        </div>
                        <h3 class="text-xl font-bold text-gray-900 mb-2">Easy Ticketing</h3>
                        <p class="text-gray-500">Secure your tickets instantly online and skip the box office lines.</p>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="feature-card">
    ...
    <section class="stats-section">
        <div class="container">
            <div class="row text-center g-4">
                <div class="col-6 col-md-3">
                    <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform">
                        <div class="text-4xl font-black text-brand mb-2">100K+</div>
                        <div class="text-gray-600 font-medium">Happy Attendees</div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform">
                        <div class="text-4xl font-black text-brand mb-2">5,000+</div>
                        <div class="text-gray-600 font-medium">Live Events</div>
                    </div>
                </div>
                <div class="col-6 col-md-3">
                    <div class="text-center p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:-translate-y-1 transition-transform">
                        <div class="text-4xl font-black text-brand mb-2">2M+</div>
            ...
            <div class="row g-4 position-relative">
                ...
                <div class="col-md-4">
                    <div class="step-card">
                        ...
                        <p>Browse available events, compare itineraries, check reviews and find your match.</p>
                        <div class="step-arrow d-none d-md-block"><i class="fa fa-chevron-right"></i></div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="step-card">
                        ...
                        <h5>Confirm & Stay</h5>
                        <p>Pay securely online, receive your booking voucher instantly, and enjoy your event!</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="routes-section">
        <div class="container">
            ...
            <p class="section-subtitle">Thousands of attendees book events in these cities every day</p>
            <div class="text-center">
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Events in Goa</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Events in Delhi</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Events in Mumbai</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Events in Jaipur</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Events in Bangalore</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Events in Udaipur</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Events in Shimla</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Events in Manali</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Events in Chennai</a>
                <a href="#" class="route-chip"><i class="fa fa-map-marker"></i> Events in Kolkata</a>
            </div>
        </div>
    </section>
    ...
    <section class="faq-section">
        <div class="container">
            ...
            <p class="section-subtitle">Everything you need to know about event booking</p>
                ...
                <div class="col-lg-8">
                    <div x-data="{ active: false }" class="mb-4">
                        <button @click="active = !active" class="w-full flex items-center justify-between bg-white p-5 rounded-xl border border-gray-200 hover:border-brand transition-colors focus:outline-none group" :class="active ? 'rounded-b-none border-brand' : ''">
                            <span class="font-bold text-gray-900">Are e-tickets accepted?</span>
                        ...
                        <div x-show="active" x-collapse>
                            <div class="p-5 bg-white border border-t-0 border-gray-200 rounded-b-xl text-gray-600">
                                Yes, almost all of our partner venues accept mobile e-tickets. You can simply show the QR code on your phone at the entrance.
                            </div>
                        </div>
                    </div>
                    <!-- FAQ 2 -->
                    <div x-data="{ active: false }" class="mb-4">
                        <button @click="active = !active" class="w-full flex items-center justify-between bg-white p-5 rounded-xl border border-gray-200 hover:border-brand transition-colors focus:outline-none group" :class="active ? 'rounded-b-none border-brand' : ''">
                            <span class="font-bold text-gray-900">Can I transfer my ticket to someone else?</span>
                            <span class="text-brand group-hover:scale-110 transition-transform"><i class="fa" :class="active ? 'fa-minus-circle' : 'fa-plus-circle'"></i></span>
                        </button>
                        <div x-show="active" x-collapse>
                            <div class="p-5 bg-white border border-t-0 border-gray-200 rounded-b-xl text-gray-600">
                                Ticket transfers depend on the event organizer's policy. Many events allow name changes up to 24 hours before the event starts.
                            </div>
                        </div>
                    </div>
                    <!-- FAQ 3 -->
                    <div x-data="{ active: false }" class="mb-4">
                        <button @click="active = !active" class="w-full flex items-center justify-between bg-white p-5 rounded-xl border border-gray-200 hover:border-brand transition-colors focus:outline-none group" :class="active ? 'rounded-b-none border-brand' : ''">
                            <span class="font-bold text-gray-900">What is the refund policy?</span>
                            <span class="text-brand group-hover:scale-110 transition-transform"><i class="fa" :class="active ? 'fa-minus-circle' : 'fa-plus-circle'"></i></span>
                        </button>
                        <div x-show="active" x-collapse>
                            <div class="p-5 bg-white border border-t-0 border-gray-200 rounded-b-xl text-gray-600">
                                Refunds are generally only provided if an event is canceled or rescheduled. Please check the specific terms and conditions on the event page.
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 mb-4">
                    ...
                    <a href="#">Delhi Events</a>
                    <a href="#">Mumbai Events</a>
                    <a href="#">Bangalore Events</a>
                    <a href="#">Pune Events</a>
                    <a href="#">Hyderabad Events</a>
                </div>
                <div class="col-md-3 mb-4">
                    <h5><i class="fa fa-star mr-2" style="color:#ff5f1f;"></i> Luxury Events</h5>
                    <a href="#">Private Events in Goa</a>
                    <a href="#">Luxury Events in Delhi</a>
                    <a href="#">Private Events in Mumbai</a>
                    <a href="#">Helicopter Rides in Udaipur</a>
                    <a href="#">Heritage Events in Jaipur</a>
                </div>
                <div class="col-md-3 mb-4">
                ...
                <div class="col-md-3 mb-4">
                    <h5><i class="fa fa-tree mr-2" style="color:#ff5f1f;"></i> Event Types</h5>
                    <a href="#">Day Trips</a>
                    <a href="#">Multi-day Events</a>
                    <a href="#">Private Events</a>
                    <a href="#">Group Events</a>
                    <a href="#">Boat Events</a>
                </div>
            </div>
        </div>
    </section>
