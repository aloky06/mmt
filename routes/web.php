...
Route::get('/', '\Modules\Car\Controllers\CarController@index');
...
Route::post('login/send-otp','\Modules\User\Controllers\UserController@sendOtp')->name('auth.login.send_otp');
Route::post('login/verify-otp','\Modules\User\Controllers\UserController@verifyOtp')->name('auth.login.verify_otp');
